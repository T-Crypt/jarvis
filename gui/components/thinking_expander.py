"""
ThinkingExpander component - JARVIS-style collapsible reasoning UI.
"""
...
class RotatingSpinner(QWidget):
    def __init__(self, text="◎", color="#ffd700", font_size=18, parent=None):
    ...
    def set_complete(self):
        self.stop_animation()
        self._text = "✓"
        self._color = QColor("#00d4ff") # Returns to cyan when done
        self.update()
...
class ThinkingExpander(QFrame):
    ...
    def _setup_ui(self):
        ...
        self.title_label = QLabel("SYNTHESIZING...")
        self.title_label.setStyleSheet("color: #ffd700; font-size: 12px; font-family: Consolas; letter-spacing: 2px; font-weight: bold;")
    ...
    def complete(self):
        ...
        self.title_label.setText("SYNTHESIS COMPLETE")
        self.title_label.setStyleSheet("color: #00d4ff; font-size: 12px; font-family: Consolas; letter-spacing: 2px; font-weight: bold;")
        self.setStyleSheet("""
            QFrame#thinkingExpander {
                background-color: rgba(10, 22, 40, 0.6);
            ...
            QFrame#thinkingHeader:hover { background-color: rgba(0, 212, 255, 0.1); }
        """)